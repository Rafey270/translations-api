...
class AuthenticationApi
{
     ...
     * @return \OpenAPI\Client\Model\LoginPost200Response
     */
    public function loginPost($login_post_request, string $contentType = self::contentTypes['loginPost'][0])
    {
        list($response) = $this->loginPostWithHttpInfo($login_post_request, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\LoginPost200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function loginPostWithHttpInfo($login_post_request, string $contentType = self::contentTypes['loginPost'][0])
    {
        $request = $this->loginPostRequest($login_post_request, $contentType);
     ...
     */
    public function loginPostAsync($login_post_request, string $contentType = self::contentTypes['loginPost'][0])
    {
        return $this->loginPostAsyncWithHttpInfo($login_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loginPostAsyncWithHttpInfo($login_post_request, string $contentType = self::contentTypes['loginPost'][0])
    {
        $returnType = '\OpenAPI\Client\Model\LoginPost200Response';
        $request = $this->loginPostRequest($login_post_request, $contentType);
     ...
     */
    public function loginPostRequest($login_post_request, string $contentType = self::contentTypes['loginPost'][0])
    {
        ...
        if (isset($login_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($login_post_request));
            } else {
    ...
    {
        $this->registerPostWithHttpInfo($register_post_request, $contentType);
    }
